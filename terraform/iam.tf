    ...
    Statement = [
      {
        ...
        Resource = [
          aws_ecr_repository.employee_registry.arn
        ]
      }
    ]
  })
...
resource "aws_iam_role_policy" "ecs_execution_secrets_manager_policy" {
  name = "${var.environment}-ecs-execution-secrets-manager-policy"
  role = aws_iam_role.ecs_execution_role.id
    ...
    Statement = [
      {
        ...
        Resource = [
          aws_secretsmanager_secret.employee_registry.arn
        ]
      }
    ]
  })
